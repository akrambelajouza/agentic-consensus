...
V3 retains V1's intake, fixed criteria, author/reviewer loop, and moderator finalizer.
...
Because V1 and V3 share topology and call count, their later comparison isolates
reviewer posture more cleanly than a comparison with V2: criteria timing and moderator
